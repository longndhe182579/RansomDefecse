    ...
    public:
        ...
        bool OnFirstTouch(DWORD pid, const std::wstring& filePath) {
...

            {
                ...
                /*
                 * CHỈ đánh dấu dirty — KHÔNG ghi đĩa ở đây.
                 *
                 * LỖI ĐÃ SỬA (máy lag): bản cũ gọi WriteManifest() ngay tại đây,
                 * trong lock, TRONG ĐƯỜNG PEND. WriteManifest ghi lại TOÀN BỘ
                 * manifest + FlushFileBuffers (ép ghi xuống đĩa thật, hàng chục ms).
                 * Mỗi file backup = một lần flush đĩa, giữ global mutex, IRP treo chờ.
                 * MaintenanceThread ghi gộp mỗi 5 giây thay thế.
                 */
